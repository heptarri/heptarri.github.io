...
<span class="line"><span>}</span></span></code></pre></div><p>其中需要说明的是：</p><p>对于宏 <code>TIMEOUT_PERIOD = 40000000</code>：</p><p>将其设为时钟频率，则为 1s 的定时；降低频率则对应比例升高该值，反之亦然。</p><p>中断函数名与在 GptChannelConfiguration 配置的相同。</p><p>至此配置完毕。</p>`,29)])])}const g=s(r,[["render",o]]);export{f as __pageData,g as default};
